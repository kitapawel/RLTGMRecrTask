...
public class PopulateLaunchInfo : MonoBehaviour
{
    ...
    {
        //store the required information in temporary string
        ...
        SetStatusOfFlight(isFlightUpcoming, stringToPrint);
    ...
    private void SetStatusOfFlight(bool isFlightUpcoming, string stringToPrint)
    {
